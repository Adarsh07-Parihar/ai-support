(function (){
    ...
    const api_Url="https://ai-support-nine-theta.vercel.app/api/chat"
    ...
    // 1. Maintain the chat context state array here
    let chatHistory = [];
    ...
    // Handle pressing Enter inside input field
    input.onkeydown=(e)=>{
    ...
    sendBtn.onclick=async()=>{
        ...
        try {
            // 2. Send the current message AND the historical logs built up so far
            ...
            // 3. Keep memory running: Append this complete exchange turn into local state
            ...
            addMessage("Could not reach support right now.","ai")
        }
    }
