...
function HomeClient({ email }: { email: string }) {
  ...
  const [currentYear, setCurrentYear] = useState<string>('2026') // Safe hydration default
  ...
  // 1. Safe Hydration for Date & 2. Fixed Dependency Array
  useEffect(() => {
  ...
  // Moved outside the component render loop so it doesn't re-create on every render pass
  const features = [
    {
      title: "Plug & Play",
      ...
      <section className='pt-36 pb-28 px-6'>
        <div className='max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 items-center'>
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }} // Fixed animate y property matching design flow
