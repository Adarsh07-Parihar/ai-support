        ...
        <div className='min-h-screen bg-zinc-50 text-zinc-900'>
            <div className='sticky top-0 z-40 bg-white border-b border-zinc-200'>
                <div className='max-w-7xl mx-auto px-6 h-16 flex items-center justify-between'>
                    <div className='text-lg font-semibold cursor-pointer' onClick={() => navigate.push("/")}>Support<span
                ...
                transition' onClick={() => navigate.push("/dashboard")}>Back to Dashboard</button>
                </div>
            ...
            <div className='flex justify-center px-4 py-14'>
                ...
                >
                    ...
                    <div className='relative bg-zinc-900 text-zinc-100 rounded-xl p-5 text-sm font-mono
            mb-10'>
                        <pre className='overflow-x-auto'>{embedCode}</pre>
                        <button className='absolute top-3 right-3 bg-white text-zinc-900 text-xs font-medium
                px-3 py-1.5 rounded-lg hover:bg-zinc-200 transition' onClick={copyCode}>
                            {copied ? "Copied ✓" : "Copy"}
                        </button>
                    </div>
                    ...
                    <ol className='space-y-3 text-sm text-zinc-600 list-decimal list-inside'>
                        ...
                        <li>Paste it befor the closing body tag</li>
                    ...
                    <div className='mt-14'>
                        ...
                        <p className='
                        text-sm text-zinc-500 mb-6'>This is how the chatbot will appear on your website</p>
<div className='rounded-xl border border-zinc-300 bg-white shadow-md overflow-hidden'>
    ...
    shadow-xl border border-zinc-200 overflow-hidden'>
        ...
        <div className='p-3 space-y-2 bg-zinc-50'>
            ...
            <div className='bg-black text-white text-xs px-3 py-2 rounded-lg w-fit ml-auto'>what is the return policy</div>
        </div>
    </div>
    <motion.div
    animate={{y:[0,-8,0]}}
